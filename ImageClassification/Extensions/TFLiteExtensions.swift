...
extension UIImage {
  ...
  public func scaledData2(with size: CGSize) -> Data? {
    ...
    public func scaledData(with size: CGSize) -> Data? {
       ...
       let bitmapInfo = CGBitmapInfo(
         rawValue: CGImageAlphaInfo.premultipliedFirst.rawValue|CGBitmapInfo.byteOrder32Little.rawValue//CGImageAlphaInfo.none.rawValue
       )
       let width = Int(size.width)
       guard let context = CGContext(
         data: nil,
